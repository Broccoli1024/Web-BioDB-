...
<th>image</th><th>GameURL</th><th>maker</th><th>establish</th><th>area</th><th>CompanyURL</th></tr>
</thead>
<tbody>
...
foreach($result as $row) {
	...
	<a>タグを入れてリンクを貼っている*/
	print "<a href='./link2pdb.php?gameID=".htmlspecialchars($row["gameID"],ENT_QUOTES)."'>";
